...
ECHO Creating "D:\Program Files\Microsoft SQL Server\MSSQL10.MSSQLSERVER\MSSQL\DATA\"... 
MKDIR "D:\Program Files\Microsoft SQL Server\MSSQL10.MSSQLSERVER\MSSQL\DATA"
...
echo Step 6.1 Create EBS Tables, Views, Triggers and Keys
SQLCMD -S %DBSVR% -U sa -P DBAdm1n@BHS.irel -i ".\6.1.EBS_CreateTable.sql" -o .\_Step5.4.log
