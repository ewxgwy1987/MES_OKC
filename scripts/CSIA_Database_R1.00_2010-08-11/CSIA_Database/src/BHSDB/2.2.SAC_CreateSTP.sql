...
--    33. [stp_SAC_UPDATINGBAGINFOTABLE] - Use for updating the same LP by removed previous record and updated to new record in the Bag_Info table
--	  34. [stp_FIS_DEPARTUREFLIGHTINFORMATIONCREATEDUPDATED] - Use for FISENGN to insert data when received DFCU.
--	  35. [stp_FIS_ERRORMESSAGE] - Use for FISENGN to insert error data when received DFCU, DFDL.
--	  36. [stp_FIS_DEPARTUREFLIGHTINFORMATIONDELETED] - Use for FISENGN to insert error data when received DFDL.
--	  37. [stp_FIS_DEPARTUREFLIGHTALLOCATIONDELETED] - Use for FISENGN to insert historical data when send FADL to FIS.
--	  38. [stp_FIS_DEPARTUREFLIGHTALLOCATIONREPLY] - Use for FISENGN to insert historical data when send FARL to FIS.
--	  39. [stp_FIS_DEPARTUREFUNCTIONALLOCATIONDELETED] - Use for FISENGN to insert historical data when send FUDL to FIS.
--	  40. [stp_FIS_DEPARTUREFUNCTIONALLOCATIONREPLY] - Use for FISENGN to insert historical data when send FURL to FIS.
--	  41. [stp_FIS_GETBHSFISOUTGOINGALLOCATIONS] - Use for FISENGN to get data when send FARL/FADL/FURL/FUDL to FIS.
--	  42. [stp_FIS_GETDEPARTUREFLIGHTALLOCATIONREPLY] - Use for FISENGN to get data when send FARL to FIS.
--	  43. [stp_FIS_GETDEPARTUREFUNCTIONTALLOCATIONREPLY] - Use for FISENGN to get data when send FURL to FIS.
--	  44. [stp_UPDATECHANGEDCONNECTIONMONITORING] - Use for update the connection status into [APP_LIVE_MONITORING].
--	  45. [stp_BSI_ERRORMESSAGE] - Use for BSIENGN to insert error data when received error BSM.
--	  46. [stp_BSI_INSERTBSM] - Use for BSIENGN to insert BSM data when received BSM.
--	  47. [stp_BSI_MULTIPLEBSMCOUNT] - Use for BSIENGN to count how many same BSM with when received BSM.
--	  48. [stp_BSI_GETBPMDATA] - Use for BSIENGN to collect all related information for contruct BPM.
--	  49. [stp_BSI_ENCAPSULATEDBPM] - Use for BSIENGN to log contructed BPM which send to gateway.
--	  50. [stp_BSI_BSMRAWDATA] - Use for BSIENGN to log raw data for BSM which received from gateway.
--	  51. [stp_FIS_RAWDATA] - Use for FISENGN to log raw data for FIS which received from gateway.
--	  52. [stp_SAC_VALIDATIONOFFOURDIGITSTAG] - Use for PLCEngn to check the 4 digits tag whether is security tag or fallback tag.
--	  53. [stp_SAC_BAGGAGEMEASUREMENTARRAY] - Use to store historical data when send BMAM from PLC
--	  54. [stp_SAC_FALLBACKTAGINFORMATION] - Use to store historical data when send FBTI to PLC
--	  55. [stp_SAC_FOURPIERTAGINFORMATION] - Use to store historical data when send FPTI to PLC
--	  56. [stp_SAC_SPECIALSECURITYTAGLEVEL] - Use to store historical data when send SSTL to PLC
--	  57. [stp_SAC_ITEMMINIMUMSECURITYLEVEL] - Use to store historical data when send IMSL to PLC
--	  58. [stp_SAC_MAKEUPCAROUSELANDCHUTEMAPPINGLIST] - Use to store historical data when send MCML to PLC
--	  59. [stp_SAC_ITEMCUSTOMSSCREENED] - Use to store historical data when send ICCR to PLC
--	  60. [stp_SAC_SPECIALSECURITYTAGDESTINATION] - Use to store historical data when send SSTD to PLC
--    61. [stp_SAC_BAGINFOGIDUSED]		   - Insert new or update existing GID info of received GID# into 
--											 working data table [BAG_INFO] for further sortation control;
--    62. [stp_SAC_BAGINFOITEMSCREENED]    - Insert new or update existing GID info of received GID# into 
--											 working data table [BAG_INFO] for further sortation control;
--    63. [stp_SAC_BAGINFOITEMSCANNED]	   - Insert new or update existing GID info of received GID# into 
--											 working data table [BAG_INFO] for further sortation control;
--    64. [stp_SAC_BAGINFOITEMREDIRECT]    - Insert new or update existing GID info of received GID# into 
--											 working data table [BAG_INFO] for further sortation control;
--    65. [stp_SAC_BAGINFOITEMPROCEEDED]   - Insert new or update existing GID info of received GID# into 
--											 working data table [BAG_INFO] for further sortation control;
--    66. [stp_SAC_BAGINFOITEMLOST]        - Insert new or update existing GID info of received GID# into 
--											 working data table [BAG_INFO] for further sortation control;
--    67. [stp_SAC_BAGINFOITEMTRACKING]    - Insert new or update existing GID info of received GID# into 
--											 working data table [BAG_INFO] for further sortation control;
--	  68. [stp_SAC_BAGINFOBAGGAGEMEASUREMENTARRAY]  - Insert new or update existing GID info of received GID# into 
--											          working data table [BAG_INFO] for further sortation control;
--	  69. [stp_SAC_BAGINFOITEMMINIMUMSECURITYLEVEL] - Insert new or update existing GID info of received GID# into 
--											          working data table [BAG_INFO] for further sortation control;
--	  70. [stp_SAC_BAGINFOITEMCUSTOMSSCREENED]      - Insert new or update existing GID info of received GID# into 
--											          working data table [BAG_INFO] for further sortation control;
--	  71. [stp_SAC_GETCHANGEIATAFALLBACKMAPPING]	- Get IATA Fallback Mapping change data to send to PLC 
--	  72. [stp_SAC_GETALLIATAFALLBACKMAPPING]		- Get all IATA Fallback Mapping data to send to PLC 
--	  73. [stp_SAC_GETCHANGEFOURDIGITSFALLBACKMAPPING]	- Get FOUR DIGITS Fallback Mapping change data to send to PLC 
--	  74. [stp_SAC_GETALLFOURDIGITSFALLBACKMAPPING]		- Get all FOUR DIGITS Fallback Mapping data to send to PLC 
--	  75. [stp_SAC_GETCHANGEFOURDIGITSSECURITYLEVELMAPPING]	- Get FOUR DIGITS SECURITY LEVEL Mapping change data to send to PLC 
--	  76. [stp_SAC_GETALLFOURDIGITSSECURITYLEVELMAPPING]	- Get all FOUR DIGITS SECURITY LEVEL Mapping data to send to PLC 
--	  77. [stp_SAC_GETCHANGEFOURDIGITSSECURITYDESTINATIONMAPPING]	- Get FOUR DIGITS SECURITY DESTINATION Mapping change data to send to PLC 
--	  78. [stp_SAC_GETALLFOURDIGITSSECURITYDESTINATIONMAPPING]		- Get all FOUR DIGITS SECURITY DESTINATION Mapping data to send to PLC 
--	  79. [stp_SAC_GETALLCHUTEMAPPING]								- Get all CHUTE Mapping data to send to PLC 
--	  80. [stp_SAC_AIRPORTCODEINFORMATION]							- To Store historical data for ACLI send to PLC 
--	  81. [stp_SAC_COLLECTCHANGEDTABLES]							- Get all TABLES CHANGED and send to PLC 
--	  82. [stp_SAC_GETSECURITYTAGLEVEL]								- Get Security Tag Level from SEcurity Level Mapping. 
--
--
--
...
BEGIN
	...
	INSERT INTO [ITEM_SCANNED] 
		   ([TIME_STAMP], [GID], [SUBSYSTEM], [LOCATION], [LICENSE_PLATE1], [LICENSE_PLATE2],[LICENSE_PLATE3], [SCANNER_ID], [STATUS_TYPE],
	...
	VALUES  (GETDATE(), @GID, @SubSystem, @Location, @LicensePlate1, @LicensePlate2, @LicensePlate3, @ScannerID, @Status, 
...
BEGIN
	...
	---- Step 2: Check have any record(s) in the table [BAG_INFO] for same Lincese Plate						
	--EXEC [dbo].[stp_SAC_UPDATINGBAGINFOTABLE] 
	--@GID = @GID,
	--@LicensePlate = @LicensePlate
	
	-- Step 3: Insert Item Proceeded bag event into event table [ITEM_PROCEEDED].
...
BEGIN
	...
	---- Step 3: Check have any record(s) in the table [BAG_INFO] for same Lincese Plate						
	--EXEC [dbo].[stp_SAC_UPDATINGBAGINFOTABLE] 
	--@GID = @GID,
	--@LicensePlate = @LicensePlate
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_UPDATINGBAGINFOTABLE]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_UPDATINGBAGINFOTABLE]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_UPDATINGBAGINFOTABLE]...'
	DROP PROCEDURE [dbo].[stp_SAC_UPDATINGBAGINFOTABLE]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_UPDATINGBAGINFOTABLE]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_UPDATINGBAGINFOTABLE]
	@GID [varchar](10), 
	@LicensePlate [varchar](10)
AS
BEGIN
	
	DECLARE @NoSameLP int
	SET @NoSameLP = (SELECT Count(*) FROM [BAG_INFO] WHERE [LICENSE_PLATE]=@LicensePlate 
						AND [LICENSE_PLATE]!='9999999999' AND [LICENSE_PLATE]!='0000000000')		
	IF @NoSameLP > 1
	BEGIN
		-- If more than one records, update the latest record based on LP
		DECLARE @OldGID [varchar](10), @OldLP1 [varchar](10), @OldLP2 [varchar](10), @OldLP3 [varchar](10),
					@OldCurrentHBSLevel [varchar](1),
					@OldMinSecurityLevel [varchar](1), @OldHBS1Result [varchar](1), @OldHBS2Result [varchar](1),
					@OldHBS3Result [varchar](1), @OldHBS4Result [varchar](1), @OldHBS5Result [varchar](1),
					@OldCustomsResult [varchar](1), @OldReason [varchar](2),
					@OldDest1 [varchar](20), @OldDest2 [varchar](20), @OldDest3 [varchar](20), @OldRecycleCount decimal(2,0),
					@OldLastLocation [varchar](20), @OldEncodedType [varchar](2), @OldOOG bit, @OldEBS bit
		
		SET @OldGID = (SELECT GID FROM [BAG_INFO] WHERE [LICENSE_PLATE]=@LicensePlate AND GID!=@GID)
		
		SELECT @OldLP1=LICENSE_PLATE1, @OldLP2=LICENSE_PLATE2, @OldLP3=LICENSE_PLATE3, @OldCurrentHBSLevel=CURRENT_HBS_LEVEL,
					@OldMinSecurityLevel=MIN_SECURITY_LEVEL, @OldHBS1Result=HBS1_RESULT, @OldHBS2Result=HBS2_RESULT,
					@OldHBS3Result=HBS3_RESULT, @OldHBS4Result=HBS4_RESULT, @OldHBS5Result=HBS5_RESULT,
					@OldCustomsResult=CUSTOMS_RESULT, @OldReason=SORT_REASON,
					@OldDest1=DEST1, @OldDest2=DEST2, @OldDest3=DEST3, @OldRecycleCount=RECYLE_COUNT,
					@OldLastLocation=LAST_LOCATION, @OldEncodedType=ENCODED_TYPE, @OldOOG=OOG, @OldEBS=EBS 
			FROM [BAG_INFO] WHERE GID=@OldGID			
	
		DECLARE @EmptyLP1 bit, @EmptyLP2 bit, @EmptyLP3 bit, @EmptyCurrentHBSLevel bit, @EmptyMinSecurityLevel bit, @EmptyHBS1Result bit, 
					@EmptyHBS2Result bit, @EmptyHBS3Result bit, @EmptyHBS4Result bit, @EmptyHBS5Result bit, @EmptyCustomsResult bit,
					@EmptyReason bit, @EmptyDest1 bit, @EmptyDest2 bit, @EmptyDest3 bit, @EmptyRecycleCount bit, @EmptyLastLocation bit,
					@EmptyEncodedType bit, @EmptyOOG bit, @EmptyEBS bit
				
		SET @EmptyLP1 = (SELECT CASE WHEN [LICENSE_PLATE1]='0000000000' OR [LICENSE_PLATE1] IS NULL OR [LICENSE_PLATE1]=''  
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)
		SET @EmptyLP2 = (SELECT CASE WHEN [LICENSE_PLATE2]='0000000000' OR [LICENSE_PLATE2] IS NULL OR [LICENSE_PLATE2]=''  
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)
		SET @EmptyLP3 = (SELECT CASE WHEN [LICENSE_PLATE3]='0000000000' OR [LICENSE_PLATE3] IS NULL OR [LICENSE_PLATE3]=''  
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)
		SET @EmptyCurrentHBSLevel = (SELECT CASE WHEN [CURRENT_HBS_LEVEL] IS NULL OR [CURRENT_HBS_LEVEL]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)									
		SET @EmptyMinSecurityLevel = (SELECT CASE WHEN [MIN_SECURITY_LEVEL] IS NULL OR [MIN_SECURITY_LEVEL]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)	
		SET @EmptyHBS1Result = (SELECT CASE WHEN [HBS1_RESULT] IS NULL OR [HBS1_RESULT]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)							
		SET @EmptyHBS2Result = (SELECT CASE WHEN [HBS2_RESULT] IS NULL OR [HBS2_RESULT]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)
		SET @EmptyHBS3Result = (SELECT CASE WHEN [HBS3_RESULT] IS NULL OR [HBS3_RESULT]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)			
		SET @EmptyHBS4Result = (SELECT CASE WHEN [HBS4_RESULT] IS NULL OR [HBS4_RESULT]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)
		SET @EmptyHBS5Result = (SELECT CASE WHEN [HBS5_RESULT] IS NULL OR [HBS5_RESULT]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)
		SET @EmptyCustomsResult = (SELECT CASE WHEN [CUSTOMS_RESULT] IS NULL OR [CUSTOMS_RESULT]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)	
		SET @EmptyReason = (SELECT CASE WHEN [SORT_REASON] IS NULL OR [SORT_REASON]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)							
		SET @EmptyDest1 = (SELECT CASE WHEN [DEST1] IS NULL OR [DEST1]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)								
		SET @EmptyDest2 = (SELECT CASE WHEN [DEST2] IS NULL OR [DEST2]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)
		SET @EmptyDest3 = (SELECT CASE WHEN [DEST3] IS NULL OR [DEST3]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)
		SET @EmptyRecycleCount = (SELECT CASE WHEN [RECYLE_COUNT] IS NULL OR [RECYLE_COUNT]=0 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)							
		SET @EmptyLastLocation = (SELECT CASE WHEN [LAST_LOCATION] IS NULL OR [LAST_LOCATION]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)	
		SET @EmptyEncodedType = (SELECT CASE WHEN [ENCODED_TYPE] IS NULL OR [ENCODED_TYPE]='' 
							THEN  1 ELSE 0 END	FROM [BAG_INFO] WHERE GID=@GID)							
		SET @EmptyOOG = (SELECT CASE WHEN [OOG] = 0 THEN 1 ELSE 0 END FROM [BAG_INFO] WHERE GID=@GID)	
		SET @EmptyEBS = (SELECT CASE WHEN [EBS] = 0 THEN 1 ELSE 0 END FROM [BAG_INFO] WHERE GID=@GID)	
		
		DECLARE @TempString varchar(1000) 
		SET @TempString = ''
																																				
		IF @EmptyLP1 = 1 AND (@OldLP1 IS NOT NULL OR @OldLP1 != '')
		BEGIN
			IF @TempString = ''
				SET @TempString = ('[LICENSE_PLATE1]=''' + @OldLP1 + '''')
			ELSE
				SET @TempString = (@TempString + ',[LICENSE_PLATE1]=''' + @OldLP1 + '''')
		END
																																						
		IF @EmptyLP2 = 1 AND (@OldLP2 IS NOT NULL OR @OldLP2 != '')
		BEGIN
			IF @TempString = ''
				SET @TempString = ('[LICENSE_PLATE2]=''' + @OldLP2 + '''')
			ELSE
				SET @TempString = (@TempString + ',[LICENSE_PLATE2]=''' + @OldLP2 + '''')
		END
																																				
		IF @EmptyLP3 = 1 AND (@OldLP3 IS NOT NULL OR @OldLP3 != '')
		BEGIN
			IF @TempString = ''
				SET @TempString = ('[LICENSE_PLATE3]=''' + @OldLP3 + '''')
			ELSE
				SET @TempString = (@TempString + ',[LICENSE_PLATE3]=''' + @OldLP3 + '''')	
		END			
																																				
		IF @EmptyCurrentHBSLevel = 1 AND (@OldCurrentHBSLevel IS NOT NULL OR @OldCurrentHBSLevel != '')
		BEGIN		
			IF @TempString = ''
				SET @TempString = ('[CURRENT_HBS_LEVEL]=''' + @OldCurrentHBSLevel + '''')
			ELSE
				SET @TempString = (@TempString + ',[CURRENT_HBS_LEVEL]=''' + @OldCurrentHBSLevel + '''')
		END
																																						
		IF @EmptyMinSecurityLevel = 1 AND (@OldMinSecurityLevel IS NOT NULL OR @OldMinSecurityLevel != '')
		BEGIN		
			IF @TempString = ''
				SET @TempString = ('[MIN_SECURITY_LEVEL]=''' + @OldMinSecurityLevel + '''')
			ELSE
				SET @TempString = (@TempString + ',[MIN_SECURITY_LEVEL]=''' + @OldMinSecurityLevel + '''')
		END
			
		IF @EmptyHBS1Result = 1	AND (@OldHBS1Result IS NOT NULL OR @OldHBS1Result != '')
		BEGIN
			IF @TempString = ''
				SET @TempString = ('[HBS1_RESULT]=''' + @OldHBS1Result + '''')
			ELSE
				SET @TempString = (@TempString + ',[HBS1_RESULT]=''' + @OldHBS1Result + '''')
		END	
			
		IF @EmptyHBS2Result = 1 AND (@OldHBS2Result IS NOT NULL OR @OldHBS2Result != '')
		BEGIN			
			IF @TempString = ''
				SET @TempString = ('[HBS2_RESULT]=''' + @OldHBS2Result + '''')
			ELSE
				SET @TempString = (@TempString + ',[HBS2_RESULT]=''' + @OldHBS2Result + '''')
		END							
			
		IF @EmptyHBS3Result = 1	AND (@OldHBS3Result IS NOT NULL OR @OldHBS3Result != '')
		BEGIN
			IF @TempString = ''
				SET @TempString = ('[HBS3_RESULT]=''' + @OldHBS3Result + '''')
			ELSE
				SET @TempString = (@TempString + ',[HBS3_RESULT]=''' + @OldHBS3Result + '''')	
		END		
			
		IF @EmptyHBS4Result = 1 AND (@OldHBS4Result IS NOT NULL OR @OldHBS4Result != '')
		BEGIN			
			IF @TempString = ''
				SET @TempString = ('[HBS4_RESULT]=''' + @OldHBS4Result + '''')
			ELSE
				SET @TempString = (@TempString + ',[HBS4_RESULT]=''' + @OldHBS4Result + '''')
		END							
			
		IF @EmptyHBS5Result = 1 AND (@OldHBS5Result IS NOT NULL OR @OldHBS5Result != '')
		BEGIN			
			IF @TempString = ''
				SET @TempString = ('[HBS5_RESULT]=''' + @OldHBS5Result + '''')
			ELSE
				SET @TempString = (@TempString + ',[HBS5_RESULT]=''' + @OldHBS5Result + '''')
		END		
			
		IF @EmptyCustomsResult = 1	AND (@OldCustomsResult IS NOT NULL OR @OldCustomsResult != '')	
		BEGIN
			IF @TempString = ''
				SET @TempString = ('[CUSTOMS_RESULT]=''' + @OldCustomsResult + '''')
			ELSE
				SET @TempString = (@TempString + ',[CUSTOMS_RESULT]=''' + @OldCustomsResult + '''')	
		END		
				
		IF @EmptyReason = 1	AND (@OldReason IS NOT NULL OR @OldReason != '')
		BEGIN
			IF @TempString = ''
				SET @TempString = ('[SORT_REASON]=''' + @OldReason + '''')
			ELSE
				SET @TempString = (@TempString + ',[SORT_REASON]=''' + @OldReason + '''')		
		END			

		IF @EmptyDest1 = 1	AND (@OldDest1 IS NOT NULL OR @OldDest1 != '')
		BEGIN		
			IF @TempString = ''
				SET @TempString = ('[DEST1]=''' + @OldDest1 + '''')
			ELSE
				SET @TempString = (@TempString + ',[DEST1]=''' + @OldDest1 + '''')		
		END			
			
		IF @EmptyDest2 = 1	AND (@OldDest2 IS NOT NULL OR @OldDest2 != '')
		BEGIN		
			IF @TempString = ''
				SET @TempString = ('[DEST2]=''' + @OldDest2 + '''')
			ELSE
				SET @TempString = (@TempString + ',[DEST2]=''' + @OldDest2 + '''')		
		END							
			
		IF @EmptyDest3 = 1	AND (@OldDest3 IS NOT NULL OR @OldDest3 != '')	
		BEGIN
			IF @TempString = ''
				SET @TempString = ('[DEST3]=''' + @OldDest3 + '''')
			ELSE
				SET @TempString = (@TempString + ',[DEST3]=''' + @OldDest3 + '''')
		END
			
		IF @EmptyRecycleCount = 1 AND (	@OldRecycleCount IS NOT NULL)	
		BEGIN
			IF @TempString = ''
				SET @TempString = ('[RECYLE_COUNT]=''' + @OldRecycleCount + '''')
			ELSE
				SET @TempString = (@TempString + ',[RECYLE_COUNT]=''' + @OldRecycleCount + '''')
		END	

		IF @EmptyLastLocation = 1 AND (@OldLastLocation IS NOT NULL OR @OldLastLocation != '')
		BEGIN		
			IF @TempString = ''
				SET @TempString = ('[LAST_LOCATION]=''' + @OldLastLocation + '''')
			ELSE
				SET @TempString = (@TempString + ',[LAST_LOCATION]=''' + @OldLastLocation + '''')								
		END
		
		IF @EmptyEncodedType = 1 AND (@OldEncodedType IS NOT NULL OR @OldEncodedType != '')	
		BEGIN		
			IF @TempString = ''
				SET @TempString = ('[ENCODED_TYPE]=''' + @OldEncodedType + '''')
			ELSE
				SET @TempString = (@TempString + ',[ENCODED_TYPE]=''' + @OldEncodedType + '''')		
		END
		
		IF @EmptyOOG = 1 AND (@OldOOG IS NOT NULL OR @OldOOG != '')				
		BEGIN
			IF @TempString = ''
				SET @TempString = ('[OOG]=''' + CAST(@OldOOG AS VARCHAR(1)) + '''')
			ELSE
				SET @TempString = (@TempString + ',[OOG]=''' + CAST(@OldOOG AS VARCHAR(1)) + '''')
		END

		IF @EmptyEBS = 1 AND (@OldEBS IS NOT NULL OR @OldEBS != '')	
		BEGIN	
			IF @TempString = ''
				SET @TempString = ('[EBS]=''' + CAST(@OldEBS AS VARCHAR(1)) + '''')
			ELSE
				SET @TempString = (@TempString + ',[EBS]=''' + CAST(@OldEBS AS VARCHAR(1)) + '''')							
		END							

		SET @TempString = ('UPDATE [BAG_INFO] SET ' + @TempString + ' WHERE GID=''' + @GID + '''')
		
		EXEC (@TempString)
		
		DELETE FROM BAG_INFO WHERE GID = @OldGID
	END
...
/****** Object:  StoredProcedure [dbo].[stp_SAC_VALIDATIONOFFOURDIGITSTAG]    Script Date: 01/26/2010 15:37:04 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_VALIDATIONOFFOURDIGITSTAG]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_VALIDATIONOFFOURDIGITSTAG]...'
	DROP PROCEDURE [dbo].[stp_SAC_VALIDATIONOFFOURDIGITSTAG]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_VALIDATIONOFFOURDIGITSTAG]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_VALIDATIONOFFOURDIGITSTAG]
	@Type [varchar](2),
	@Count int OUTPUT
AS
BEGIN
	SET @Count = (SELECT COUNT(*) FROM SPECIAL_SECURITY_TAG_LEVEL_MAPPING WHERE ID = @Type);	
END
GO



-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGGAGEMEASUREMENTARRAY]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGGAGEMEASUREMENTARRAY]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGGAGEMEASUREMENTARRAY]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGGAGEMEASUREMENTARRAY]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGGAGEMEASUREMENTARRAY]...'
GO
...
AS
BEGIN	
	-- Step 1: Insert Item Lost bag event into event table [BAGGAGE_MEASURE_ARRAY_MSG].
	INSERT INTO [BAGGAGE_MEASURE_ARRAY_MSG] 
		([TIME_STAMP], [GID], [LOCATION], [LICENSE_PLATE], [TYPE] )
	VALUES 
		(GETDATE(), @GID, @BMALocation, @LicensePlate, @BMAType);
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_FALLBACKTAGINFORMATION]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_FALLBACKTAGINFORMATION]...'
	DROP PROCEDURE [dbo].[stp_SAC_FALLBACKTAGINFORMATION]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_FALLBACKTAGINFORMATION]...'
GO
...
BEGIN
	...
	INSERT INTO [BHSDB].[dbo].[FALLBACK_TAG_INFO]
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_FOURPIERTAGINFORMATION]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_FOURPIERTAGINFORMATION]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_FOURPIERTAGINFORMATION]...'
	DROP PROCEDURE [dbo].[stp_SAC_FOURPIERTAGINFORMATION]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_FOURPIERTAGINFORMATION]...'
GO
...
BEGIN
	...
	INSERT INTO [BHSDB].[dbo].[FOUR_DIGITS_FALLBACK_TAG_INFO]
			   ([TIME_STAMP], [NO_OF_MAPPING], [TAG_NUMBER_1], [DESTINATION_1], [TAG_NUMBER_2], [DESTINATION_2],
			   [TAG_NUMBER_3], [DESTINATION_3], [TAG_NUMBER_4], [DESTINATION_4], [TAG_NUMBER_5], [DESTINATION_5],
			   [TAG_NUMBER_6], [DESTINATION_6], [TAG_NUMBER_7], [DESTINATION_7], [TAG_NUMBER_8], [DESTINATION_8],
			   [TAG_NUMBER_9], [DESTINATION_9], [TAG_NUMBER_10], [DESTINATION_10])
		 VALUES
			   (GETDATE(),@NoOfTag, @Code1, @Destination1, @Code2, @Destination2,
			   @Code3, @Destination3, @Code4, @Destination4, @Code5, @Destination5,
			   @Code6, @Destination6, @Code7, @Destination7, @Code8, @Destination8,
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_SPECIALSECURITYTAGLEVEL]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_SPECIALSECURITYTAGLEVEL]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_SPECIALSECURITYTAGLEVEL]...'
	DROP PROCEDURE [dbo].[stp_SAC_SPECIALSECURITYTAGLEVEL]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_SPECIALSECURITYTAGLEVEL]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_SPECIALSECURITYTAGLEVEL] 
	@NoOfTag [varchar](2), 
	@Code1 [varchar](2),
	@Level1 [varchar](1), 
	@Code2 [varchar](2),
...
AS
BEGIN
	-- Step 1: Insert [SPECIAL_SECURITY_TAG_LEVEL] bag event into event table [SPECIAL_SECURITY_TAG_LEVEL].
	INSERT INTO [BHSDB].[dbo].[SPECIAL_SECURITY_TAG_LEVEL]
			   ([TIME_STAMP], [NO_OF_MAPPING], [TAG_NUMBER_1], [LEVEL_1], [TAG_NUMBER_2], [LEVEL_2],
			   [TAG_NUMBER_3], [LEVEL_3], [TAG_NUMBER_4], [LEVEL_4], [TAG_NUMBER_5], [LEVEL_5],
			   [TAG_NUMBER_6], [LEVEL_6], [TAG_NUMBER_7], [LEVEL_7], [TAG_NUMBER_8], [LEVEL_8],
			   [TAG_NUMBER_9], [LEVEL_9], [TAG_NUMBER_10], [LEVEL_10])
		 VALUES
			   (GETDATE(),@NoOfTag, @Code1, @Level1, @Code2, @Level2,
			   @Code3, @Level3, @Code4, @Level4, @Code5, @Level5,
			   @Code6, @Level6, @Code7, @Level7, @Code8, @Level8,
			   @Code9, @Level9, @Code10, @Level10);
END
GO



-- ****** Object:  StoredProcedure [dbo].[stp_SAC_ITEMMINIMUMSECURITYLEVEL]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_ITEMMINIMUMSECURITYLEVEL]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_ITEMMINIMUMSECURITYLEVEL]...'
	DROP PROCEDURE [dbo].[stp_SAC_ITEMMINIMUMSECURITYLEVEL]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_ITEMMINIMUMSECURITYLEVEL]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_ITEMMINIMUMSECURITYLEVEL] 
	@GID [varchar](10), 
	@LicensePlate [varchar](10),
	@Level [varchar](1)
AS
BEGIN	
	-- Step 1: Insert ITEM_MINIMUM_SECURITY_LEVEL bag event into event table [ITEM_MINIMUM_SECURITY_LEVEL].
	INSERT INTO [ITEM_MINIMUM_SECURITY_LEVEL] 
		([TIME_STAMP], [GID], [LICENSE_PLATE], [LEVEL])
	VALUES 
		(GETDATE(), @GID, @LicensePlate, @Level);
END
GO
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_MAKEUPCAROUSELANDCHUTEMAPPINGLIST]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_MAKEUPCAROUSELANDCHUTEMAPPINGLIST]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_MAKEUPCAROUSELANDCHUTEMAPPINGLIST]...'
	DROP PROCEDURE [dbo].[stp_SAC_MAKEUPCAROUSELANDCHUTEMAPPINGLIST]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_MAKEUPCAROUSELANDCHUTEMAPPINGLIST]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_MAKEUPCAROUSELANDCHUTEMAPPINGLIST] 
	@NoOfTag [varchar](2), 
	@MakeUp1 [varchar](10),
	@Chute1 [varchar](10), 
	@MakeUp2 [varchar](10),
...
AS
BEGIN
	-- Step 1: Insert [MAKEUP_CAROUSEL_CHUTE_MAPPING_LIST] bag event into event table [MAKEUP_CAROUSEL_CHUTE_MAPPING_LIST].
	INSERT INTO [BHSDB].[dbo].[MAKEUP_CAROUSEL_CHUTE_MAPPING_LIST]
			   ([TIME_STAMP], [NO_OF_MAPPING], [MAKEUP_1], [CHUTE_1], [MAKEUP_2], [CHUTE_2],
			   [MAKEUP_3], [CHUTE_3], [MAKEUP_4], [CHUTE_4], [MAKEUP_5], [CHUTE_5],
			   [MAKEUP_6], [CHUTE_6], [MAKEUP_7], [CHUTE_7], [MAKEUP_8], [CHUTE_8],
			   [MAKEUP_9], [CHUTE_9], [MAKEUP_10], [CHUTE_10])
		 VALUES
			   (GETDATE(),@NoOfTag, @MakeUp1, @Chute1, @MakeUp2, @Chute2,
			   @MakeUp3, @Chute3, @MakeUp4, @Chute4, @MakeUp5, @Chute5,
			   @MakeUp6, @Chute6, @MakeUp7, @Chute7, @MakeUp8, @Chute8,
			   @MakeUp9, @Chute9, @MakeUp10, @Chute10);
END
GO



-- ****** Object:  StoredProcedure [dbo].[stp_SAC_ITEMCUSTOMSSCREENED]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_ITEMCUSTOMSSCREENED]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_ITEMCUSTOMSSCREENED]...'
	DROP PROCEDURE [dbo].[stp_SAC_ITEMCUSTOMSSCREENED]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_ITEMCUSTOMSSCREENED]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_ITEMCUSTOMSSCREENED] 
	@GID [varchar](10), 
	@SubSystem [varchar](10),
	@Location [varchar](20),  
	@LicensePlate [varchar](10),
...
AS
BEGIN
	-- Step 1: Insert Item Customs Screened bag event into event table [ITEM_CUSTOMS_SCREENED].
	INSERT INTO [ITEM_CUSTOMS_SCREENED] 
			([TIME_STAMP], [GID], [LICENSE_PLATE], [SUBSYSTEM], [LOCATION], [RESULT_TYPE]) 
	VALUES 
			(GETDATE(), @GID, @LicensePlate, @SubSystem, @Location, @Result)
END



-- ****** Object:  StoredProcedure [dbo].[stp_SAC_SPECIALSECURITYTAGDESTINATION]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_SPECIALSECURITYTAGDESTINATION]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_SPECIALSECURITYTAGDESTINATION]...'
	DROP PROCEDURE [dbo].[stp_SAC_SPECIALSECURITYTAGDESTINATION]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_SPECIALSECURITYTAGDESTINATION]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_SPECIALSECURITYTAGDESTINATION] 
	@NoOfTag [varchar](2), 
	@Code1 [varchar](4),
	@Destination1 [varchar](10), 
	@Code2 [varchar](4),
...
AS
BEGIN
	-- Step 1: Insert [SPECIAL_SECURITY_TAG_DESTINATION] bag event into event table [SPECIAL_SECURITY_TAG_DESTINATION].
	INSERT INTO [BHSDB].[dbo].[SPECIAL_SECURITY_TAG_DESTINATION]
			   ([TIME_STAMP], [NO_OF_MAPPING], [TAG_NUMBER_1], [DESTINATION_1], [TAG_NUMBER_2], [DESTINATION_2],
			   [TAG_NUMBER_3], [DESTINATION_3], [TAG_NUMBER_4], [DESTINATION_4], [TAG_NUMBER_5], [DESTINATION_5],
			   [TAG_NUMBER_6], [DESTINATION_6], [TAG_NUMBER_7], [DESTINATION_7], [TAG_NUMBER_8], [DESTINATION_8],
			   [TAG_NUMBER_9], [DESTINATION_9], [TAG_NUMBER_10], [DESTINATION_10])
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGINFOGIDUSED]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGINFOGIDUSED]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGINFOGIDUSED]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGINFOGIDUSED]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGINFOGIDUSED]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_BAGINFOGIDUSED] 
	@GID [varchar](10), 
	@Location [varchar](20), 
	@Origin [varchar](10)
AS
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGINFOITEMSCREENED]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGINFOITEMSCREENED]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGINFOITEMSCREENED]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGINFOITEMSCREENED]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGINFOITEMSCREENED]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_BAGINFOITEMSCREENED] 
	@GID [varchar](10), 
	@Location [varchar](20), 
	@LicensePlate [varchar](10),
	@Level [varchar](1), 
...
BEGIN		
	...
	BEGIN
		IF @Level = '1'
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE], [CURRENT_HBS_LEVEL], [HBS1_RESULT], 
				 [LAST_LOCATION], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate, @Level, @Result, @Location, @Origin, GETDATE())
		ELSE IF @Level = '2'
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE], [CURRENT_HBS_LEVEL], [HBS2_RESULT], 
				 [LAST_LOCATION], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate, @Level, @Result, @Location, @Origin, GETDATE())
		ELSE IF @Level = '3'
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE], [CURRENT_HBS_LEVEL], [HBS3_RESULT], 
				 [LAST_LOCATION], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate, @Level, @Result, @Location, @Origin, GETDATE())
		ELSE IF @Level = '4'
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE], [CURRENT_HBS_LEVEL], [HBS4_RESULT], 
				 [LAST_LOCATION], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate, @Level, @Result, @Location, @Origin, GETDATE())
		ELSE IF @Level = '5'
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE], [CURRENT_HBS_LEVEL], [HBS5_RESULT], 
				 [LAST_LOCATION], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate, @Level, @Result, @Location, @Origin, GETDATE())
	END
	...
	BEGIN
		IF @Level = '1'
			UPDATE [BAG_INFO]
			SET [LICENSE_PLATE]=@LicensePlate, [CURRENT_HBS_LEVEL]=@Level, [HBS1_RESULT]=@Result, 
				[LAST_LOCATION]=@Location, [CREATED_BY]=@Origin, 
				[TIME_STAMP]= GETDATE() 
			WHERE [GID]=@GID
		ELSE IF @Level = '2'
			UPDATE [BAG_INFO]
			SET [LICENSE_PLATE]=@LicensePlate, [CURRENT_HBS_LEVEL]=@Level, [HBS2_RESULT]=@Result, 
				[LAST_LOCATION]=@Location, [CREATED_BY]=@Origin, 
				[TIME_STAMP]= GETDATE() 
			WHERE [GID]=@GID
		ELSE IF @Level = '3'
			UPDATE [BAG_INFO]
			SET [LICENSE_PLATE]=@LicensePlate, [CURRENT_HBS_LEVEL]=@Level, [HBS3_RESULT]=@Result, 
				[LAST_LOCATION]=@Location, [CREATED_BY]=@Origin, 
				[TIME_STAMP]= GETDATE() 
			WHERE [GID]=@GID
		ELSE IF @Level = '4'
			UPDATE [BAG_INFO]
			SET [LICENSE_PLATE]=@LicensePlate, [CURRENT_HBS_LEVEL]=@Level, [HBS4_RESULT]=@Result, 
				[LAST_LOCATION]=@Location, [CREATED_BY]=@Origin, 
				[TIME_STAMP]= GETDATE() 
			WHERE [GID]=@GID
		ELSE IF @Level = '5'
			UPDATE [BAG_INFO]
			SET [LICENSE_PLATE]=@LicensePlate, [CURRENT_HBS_LEVEL]=@Level, [HBS5_RESULT]=@Result, 
				[LAST_LOCATION]=@Location, [CREATED_BY]=@Origin, 
				[TIME_STAMP]= GETDATE() 
			WHERE [GID]=@GID
	END	
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGINFOITEMSCANNED]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGINFOITEMSCANNED]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGINFOITEMSCANNED]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGINFOITEMSCANNED]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGINFOITEMSCANNED]...'
GO
CREATE PROCEDURE [stp_SAC_BAGINFOITEMSCANNED] 
	@GID [varchar](10), 
	@Location [varchar](20), 
	@LicensePlate1 [varchar](10), 
	@LicensePlate2 [varchar](10),
...
AS
BEGIN
	-- Step 1: Insert or Update new ISC info into sortation working table [BAG_INFO].
	DECLARE	@ExistGID [varchar](10)
	...
	-- by other bag event.
	SELECT @ExistGID=[GID], @NewCount=[RECYLE_COUNT] FROM [BAG_INFO] WHERE ([GID]=@GID)
	...
	BEGIN
		...
		BEGIN
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE1], [LICENSE_PLATE2], [LICENSE_PLATE3], [RECYLE_COUNT], 
				 [LAST_LOCATION], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate1, NULL, NULL, 0, @Location, @Origin, GETDATE())
		END
		ELSE IF @Status = '02' -- Good read, multiple tags were dectected
		BEGIN
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE1], [LICENSE_PLATE2], [LICENSE_PLATE3], [RECYLE_COUNT], 
				 [LAST_LOCATION], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate1, @LicensePlate2, @LicensePlate3, 0, @Location, @Origin, GETDATE())
		END
		...
		BEGIN
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE1], [LICENSE_PLATE2], [LICENSE_PLATE3], [RECYLE_COUNT], 
				 [LAST_LOCATION], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, NULL, NULL, NULL, 0, @Location, @Origin, GETDATE())
		END
	...
	BEGIN
		...
		BEGIN
			UPDATE [BAG_INFO]
			SET [LICENSE_PLATE1]=@LicensePlate1, [LICENSE_PLATE2]=NULL, [LICENSE_PLATE3]=NULL,
		...
		BEGIN
			UPDATE [BAG_INFO]
			SET [LICENSE_PLATE1]=@LicensePlate1, [LICENSE_PLATE2]=@LicensePlate2,  [LICENSE_PLATE3]=@LicensePlate3,
				[RECYLE_COUNT]=@Reset, [LAST_LOCATION]=@Location, 
				[CREATED_BY]=@Origin, [TIME_STAMP]= GETDATE()
			WHERE [GID]=@GID
		END
		...
		BEGIN
			UPDATE [BAG_INFO]
			SET [LICENSE_PLATE1]=NULL, [LICENSE_PLATE2]=NULL,  [LICENSE_PLATE3]=NULL,
				[RECYLE_COUNT]=@Reset, [LAST_LOCATION]=@Location, 
				[CREATED_BY]=@Origin, [TIME_STAMP]= GETDATE()
			WHERE [GID]=@GID
		END		
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGINFOITEMREDIRECT]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGINFOITEMREDIRECT]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGINFOITEMREDIRECT]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGINFOITEMREDIRECT]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGINFOITEMREDIRECT]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_BAGINFOITEMREDIRECT] 
	@GID [varchar](10), 
	@Location1 [varchar](20), 
	@Location2 [varchar](20), 
	@Location3 [varchar](20), 
...
BEGIN			
	...
	IF @No = 0
		BEGIN
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE], [SORT_REASON], [DEST1], [DEST2], [DEST3], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate, @Reason, @Location1, @Location2, @Location3, @Origin, GETDATE())
		END
	ELSE
		BEGIN
			UPDATE [BAG_INFO]
			SET [LICENSE_PLATE]=@LicensePlate, [SORT_REASON]=@Reason, [DEST1]=@Location1, [DEST2]=@Location2, 
				[DEST3]=@Location3, [CREATED_BY]=@Origin, [TIME_STAMP]= GETDATE() 
			WHERE [GID]=@GID
		END
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGINFOITEMPROCEEDED]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGINFOITEMPROCEEDED]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGINFOITEMPROCEEDED]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGINFOITEMPROCEEDED]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGINFOITEMPROCEEDED]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_BAGINFOITEMPROCEEDED] 
	@GID [varchar](10), 
	@Location [varchar](20), 
	@LicensePlate [varchar](10), 
	@Origin [varchar](10)
...
BEGIN
	...
	IF @No = 0
		BEGIN
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE], [LAST_LOCATION], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate, @Location, @Origin, GETDATE())
		END
	ELSE
		BEGIN
			UPDATE [BAG_INFO]
			SET [LAST_LOCATION]=@Location, [CREATED_BY]=@Origin, 
				[LICENSE_PLATE]=@LicensePlate, [TIME_STAMP]= GETDATE() 
			WHERE [GID]=@GID
		END
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGINFOITEMLOST]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGINFOITEMLOST]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGINFOITEMLOST]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGINFOITEMLOST]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGINFOITEMLOST]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_BAGINFOITEMLOST] 
	@GID [varchar](10), 
	@Location [varchar](20), 
	@LicensePlate [varchar](10),
	@Origin [varchar](10)
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGINFOITEMTRACKING]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGINFOITEMTRACKING]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGINFOITEMTRACKING]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGINFOITEMTRACKING]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGINFOITEMTRACKING]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_BAGINFOITEMTRACKING] 
	@GID [varchar](10), 
	@Location [varchar](20), 
	@LicensePlate [varchar](10),
	@TimeStamp [varchar](18),
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGINFOBAGGAGEMEASUREMENTARRAY]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGINFOBAGGAGEMEASUREMENTARRAY]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGINFOBAGGAGEMEASUREMENTARRAY]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGINFOBAGGAGEMEASUREMENTARRAY]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGINFOBAGGAGEMEASUREMENTARRAY]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_BAGINFOBAGGAGEMEASUREMENTARRAY] 
	@GID [varchar](10), 
	@LicensePlate [varchar](10),
	@BMALocation [varchar](10), 
	@BMAType [varchar](2),
...
BEGIN	
	...
	IF @No = 0
		BEGIN
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE], [LAST_LOCATION], [CREATED_BY], [TIME_STAMP], [OOG]) 
			VALUES 
				(@GID, @LicensePlate, @BMALocation, @Origin, GETDATE(), @OOG)
		END
	ELSE
		BEGIN
			UPDATE [BAG_INFO]
			SET [LAST_LOCATION]=@BMALocation, [CREATED_BY]=@Origin, 
				[LICENSE_PLATE]=@LicensePlate, [TIME_STAMP]= GETDATE(), [OOG] = @OOG
			WHERE [GID]=@GID
		END
	-- Step 2: Check have any record(s) in the table [BAG_INFO] for same Lincese Plate						
	EXEC [dbo].[stp_SAC_UPDATINGBAGINFOTABLE] 
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGINFOITEMMINIMUMSECURITYLEVEL]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGINFOITEMMINIMUMSECURITYLEVEL]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGINFOITEMMINIMUMSECURITYLEVEL]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGINFOITEMMINIMUMSECURITYLEVEL]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGINFOITEMMINIMUMSECURITYLEVEL]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_BAGINFOITEMMINIMUMSECURITYLEVEL] 
	@GID [varchar](10), 
	@LicensePlate [varchar](10),
	@Level [varchar](1),
	@Origin [varchar](10)		
...
BEGIN	
	...
	IF @No = 0
		BEGIN
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE], [CURRENT_HBS_LEVEL], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate, @Level, @Origin, GETDATE())
		END
	ELSE
		BEGIN
			UPDATE [BAG_INFO]
			SET [CREATED_BY]=@Origin, 
				[LICENSE_PLATE]=@LicensePlate, [MIN_SECURITY_LEVEL]=@Level, [TIME_STAMP]= GETDATE()
			WHERE [GID]=@GID
		END
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_BAGINFOITEMCUSTOMSSCREENED]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_BAGINFOITEMCUSTOMSSCREENED]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_BAGINFOITEMCUSTOMSSCREENED]...'
	DROP PROCEDURE [dbo].[stp_SAC_BAGINFOITEMCUSTOMSSCREENED]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_BAGINFOITEMCUSTOMSSCREENED]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_BAGINFOITEMCUSTOMSSCREENED] 
	@GID [varchar](10), 
	@Location [varchar](20), 
	@LicensePlate [varchar](10),
	@Result [varchar](1),
...
BEGIN
	...
	IF @No = 0
		BEGIN
			INSERT INTO [BAG_INFO] 
				([GID], [LICENSE_PLATE], [LAST_LOCATION], [CUSTOMS_RESULT], [CREATED_BY], [TIME_STAMP]) 
			VALUES 
				(@GID, @LicensePlate, @Location, @Result, @Origin, GETDATE())
		END
	ELSE
		BEGIN
			UPDATE [BAG_INFO]
			SET [CREATED_BY]=@Origin, 
				[LICENSE_PLATE]=@LicensePlate, [LAST_LOCATION]=@Location, [CUSTOMS_RESULT]=@Result, [TIME_STAMP]= GETDATE()
			WHERE [GID]=@GID
		END
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_GETCHANGEIATAFALLBACKMAPPING]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_GETCHANGEIATAFALLBACKMAPPING]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_GETCHANGEIATAFALLBACKMAPPING]...'
	DROP PROCEDURE [dbo].[stp_SAC_GETCHANGEIATAFALLBACKMAPPING]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_GETCHANGEIATAFALLBACKMAPPING]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_GETCHANGEIATAFALLBACKMAPPING] 
	@StateCode [varchar](30)
AS
BEGIN
	SELECT CODE, VALUE FROM PLC_DATA_DOWNLOAD WHERE TYPE = 'IF';
				
	UPDATE [BHSDB].[dbo].[CHANGE_MONITORING] SET IS_CHANGED = 0 WHERE STATE_CODE = @StateCode AND IS_CHANGED = 1;
	
	DELETE FROM [BHSDB].[dbo].[PLC_DATA_DOWNLOAD] WHERE TYPE = 'IF';	
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_GETALLIATAFALLBACKMAPPING]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_GETALLIATAFALLBACKMAPPING]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_GETALLIATAFALLBACKMAPPING]...'
	DROP PROCEDURE [dbo].[stp_SAC_GETALLIATAFALLBACKMAPPING]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_GETALLIATAFALLBACKMAPPING]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_GETALLIATAFALLBACKMAPPING] 
	@StateCode [varchar](30)
AS
BEGIN
	SELECT ID, DESTINATION FROM FALLBACK_MAPPING;
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_GETCHANGEFOURDIGITSFALLBACKMAPPING]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_GETCHANGEFOURDIGITSFALLBACKMAPPING]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_GETCHANGEFOURDIGITSFALLBACKMAPPING]...'
	DROP PROCEDURE [dbo].[stp_SAC_GETCHANGEFOURDIGITSFALLBACKMAPPING]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_GETCHANGEFOURDIGITSFALLBACKMAPPING]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_GETCHANGEFOURDIGITSFALLBACKMAPPING] 
	@StateCode [varchar](30)
AS
BEGIN
	SELECT CODE, VALUE FROM PLC_DATA_DOWNLOAD WHERE TYPE = 'FF';
			
	UPDATE [BHSDB].[dbo].[CHANGE_MONITORING] SET IS_CHANGED = 0 WHERE STATE_CODE = @StateCode AND IS_CHANGED = 1;
	
	DELETE FROM [BHSDB].[dbo].[PLC_DATA_DOWNLOAD] WHERE TYPE = 'FF';	
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_GETALLFOURDIGITSFALLBACKMAPPING]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_GETALLFOURDIGITSFALLBACKMAPPING]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_GETALLFOURDIGITSFALLBACKMAPPING]...'
	DROP PROCEDURE [dbo].[stp_SAC_GETALLFOURDIGITSFALLBACKMAPPING]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_GETALLFOURDIGITSFALLBACKMAPPING]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_GETALLFOURDIGITSFALLBACKMAPPING] 
	@StateCode [varchar](30)
AS
BEGIN
	SELECT ID, DESTINATION FROM FOUR_DIGITS_FALLBACK_MAPPING;
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_GETCHANGEFOURDIGITSSECURITYLEVELMAPPING]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_GETCHANGEFOURDIGITSSECURITYLEVELMAPPING]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_GETCHANGEFOURDIGITSSECURITYLEVELMAPPING]...'
	DROP PROCEDURE [dbo].[stp_SAC_GETCHANGEFOURDIGITSSECURITYLEVELMAPPING]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_GETCHANGEFOURDIGITSSECURITYLEVELMAPPING]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_GETCHANGEFOURDIGITSSECURITYLEVELMAPPING] 
	@StateCode [varchar](30)
AS
BEGIN
	SELECT CODE, VALUE FROM PLC_DATA_DOWNLOAD WHERE TYPE = 'SL';
		
	UPDATE [BHSDB].[dbo].[CHANGE_MONITORING] SET IS_CHANGED = 0 WHERE STATE_CODE = @StateCode AND IS_CHANGED = 1;
	
	DELETE FROM [BHSDB].[dbo].[PLC_DATA_DOWNLOAD] WHERE TYPE = 'SL';	
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_GETALLFOURDIGITSSECURITYLEVELMAPPING]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_GETALLFOURDIGITSSECURITYLEVELMAPPING]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_GETALLFOURDIGITSSECURITYLEVELMAPPING]...'
	DROP PROCEDURE [dbo].[stp_SAC_GETALLFOURDIGITSSECURITYLEVELMAPPING]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_GETALLFOURDIGITSSECURITYLEVELMAPPING]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_GETALLFOURDIGITSSECURITYLEVELMAPPING] 
	@StateCode [varchar](30)
AS
BEGIN
	SELECT ID, LEVEL FROM SPECIAL_SECURITY_TAG_LEVEL_MAPPING;	
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_GETCHANGEFOURDIGITSSECURITYDESTINATIONMAPPING]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_GETCHANGEFOURDIGITSSECURITYDESTINATIONMAPPING]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_GETCHANGEFOURDIGITSSECURITYDESTINATIONMAPPING]...'
	DROP PROCEDURE [dbo].[stp_SAC_GETCHANGEFOURDIGITSSECURITYDESTINATIONMAPPING]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_GETCHANGEFOURDIGITSSECURITYDESTINATIONMAPPING]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_GETCHANGEFOURDIGITSSECURITYDESTINATIONMAPPING] 
	@StateCode [varchar](30)
AS
BEGIN
	SELECT CODE, VALUE FROM PLC_DATA_DOWNLOAD WHERE TYPE = 'SD';
	
	UPDATE [BHSDB].[dbo].[CHANGE_MONITORING] SET IS_CHANGED = 0 WHERE STATE_CODE = @StateCode AND IS_CHANGED = 1;
	
	DELETE FROM [BHSDB].[dbo].[PLC_DATA_DOWNLOAD] WHERE TYPE = 'SD';	
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_GETALLFOURDIGITSSECURITYDESTINATIONMAPPING]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_GETALLFOURDIGITSSECURITYDESTINATIONMAPPING]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_GETALLFOURDIGITSSECURITYDESTINATIONMAPPING]...'
	DROP PROCEDURE [dbo].[stp_SAC_GETALLFOURDIGITSSECURITYDESTINATIONMAPPING]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_GETALLFOURDIGITSSECURITYDESTINATIONMAPPING]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_GETALLFOURDIGITSSECURITYDESTINATIONMAPPING] 
	@StateCode [varchar](30)
AS
BEGIN
	SELECT ID, DESTINATION FROM SPECIAL_SECURITY_TAG_DESTINATION_MAPPING;
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_GETALLCHUTEMAPPING]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_GETALLCHUTEMAPPING]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_GETALLCHUTEMAPPING]...'
	DROP PROCEDURE [dbo].[stp_SAC_GETALLCHUTEMAPPING]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_GETALLCHUTEMAPPING]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_GETALLCHUTEMAPPING] 
	@StateCode [varchar](30)
AS
BEGIN
	SELECT DESTINATION, TTS_ID FROM CHUTE_MAPPING
...
-- ****** Object:  StoredProcedure [dbo].[stp_SAC_AIRPORTCODEINFORMATION]    Script Date: 10/08/2007 13:18:36 ******
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_AIRPORTCODEINFORMATION]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_AIRPORTCODEINFORMATION]...'
	DROP PROCEDURE [dbo].[stp_SAC_AIRPORTCODEINFORMATION]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_AIRPORTCODEINFORMATION]...'
GO
CREATE PROCEDURE [dbo].[stp_SAC_AIRPORTCODEINFORMATION] 
	@AirportCode [varchar] (4)
AS
BEGIN
	INSERT INTO [BHSDB].[dbo].[AIRPORT_CODE_LOCATION_INFORMATION]
           ([TIME_STAMP], [AIRPORT_CODE])
     VALUES (GETDATE(), @AirportCode)		
END
GO



/****** Object:  StoredProcedure [dbo].[stp_SAC_COLLECTCHANGEDTABLES]    Script Date: 10/08/2009 15:41:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_COLLECTCHANGEDTABLES]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_COLLECTCHANGEDTABLES]...'
	DROP PROCEDURE [dbo].[stp_SAC_COLLECTCHANGEDTABLES]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_COLLECTCHANGEDTABLES]...'
GO
...
BEGIN
	...
	INSERT INTO @TEMP 
		SELECT [STATE_CODE] FROM [BHSDB].[dbo].[CHANGE_MONITORING] WHERE SAC_OWS = 'PLCEngine' AND IS_CHANGED = 1;
	
	UPDATE [BHSDB].[dbo].[CHANGE_MONITORING] SET IS_CHANGED = 0 WHERE SAC_OWS = 'PLCEngine' AND IS_CHANGED = 1 
...
/****** Object:  StoredProcedure [dbo].[stp_SAC_GETSECURITYTAGLEVEL]    Script Date: 10/08/2009 15:41:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stp_SAC_GETSECURITYTAGLEVEL]') 
	AND type in (N'P', N'PC'))
BEGIN
	PRINT 'INFO: Deleting existing StoredProcedure [stp_SAC_GETSECURITYTAGLEVEL]...'
	DROP PROCEDURE [dbo].[stp_SAC_GETSECURITYTAGLEVEL]
END
GO
PRINT 'INFO: Creating StoredProcedure [stp_SAC_GETSECURITYTAGLEVEL]...'
GO
