...
ECHO #                                                                           #
ECHO # 6.0.MES_Update.sql                                                        #
ECHO # 6.1.MES_CreateSTP.sql                                                     #
...
echo Step 6.0 Update for MES required Tables and Create Tables for MES
SQLCMD -S %DBSVR% -U sa -P DBAdm1n@BHS.irel -i ".\6.0.MES_Update.sql" -o .\_Step6.0.log

echo Step 6.1 Create MES application Stored Procedures and Scalar Functions
SQLCMD -S %DBSVR% -U sa -P DBAdm1n@BHS.irel -i ".\6.1.MES_CreateSTP.sql" -o .\_Step6.1.log
