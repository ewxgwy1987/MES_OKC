...
namespace BHS.MES.TCPClientChains.Messages.Handlers
{
    public class IRM
    {
        ...
        /// <summary>
        /// Global Identifier of Bag field value (GID_MSB).
        /// </summary>
        public int GID_MSB { get; set; }

        /// <summary>
        /// Global Identifier of Bag field value (GID_LSB).
        /// </summary>
        ...
        /// Class constructer.
        /// </summary>
        public IRM(TelegramFormat MessageFormat)
        {
            if (MessageFormat == null)
                throw new Exception("Message format can not be null! Creating IRM class object failure! " + 
        ...
        public Telegram ConstructIRMMessage()
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            Telegram msg = null;
            ...
            if (GID_MSB == 0)
            {
                if (_logger.IsErrorEnabled)
                    _logger.Error("Global identifier of Bag (GID_MSB) is empty, no IRM message is constructed! <" +
                            thisMethod + ">");
                return null;
            }
            ...
            {
                if (_logger.IsErrorEnabled)
                    _logger.Error("Global identifier of Bag (GID_LSB) is empty, no IRM message is constructed! <" +
                            thisMethod + ">");
                return null;
            }
            ...
            {
                if (_logger.IsErrorEnabled)
                    _logger.Error("PLC Index tag number is empty, no IRM message is constructed! <" +
                            thisMethod + ">");
                return null;
            }
            ...
            try
            {
              ...
              //</telegram>
                ...
                bool temp;
                byte[] type, len, seq, gid_msb, gid_lsb, location, plcIndex;
            ...
            {
                if (_logger.IsErrorEnabled)
                    _logger.Error("Constructing IRM message failed! <" +
                            thisMethod + ">", ex);
                return null;
            }
        }
