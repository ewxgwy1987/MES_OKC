...
namespace BHS.MES.TCPClientChains.DataPersistor.Database
{
    ...
    public class PersistorParameters : PALS.Common.IParameters, IDisposable
    {
        ...
        private const string DB_FUNC_ALLOCATION_DUMP = "funcAllocation_DUMP";
        ...
        private const string DB_FUNC_ALLOCATION_PROB = "funcAllocation_PROB";
        ...
        /// <summary>
        /// The FUNC_ALLOCATION_DUMP.
        /// </summary>
        public string FuncAllocationDUMP { get; set; }
        ...
        /// <summary>
        /// The FUNC_ALLOCATION_PROB.
        /// </summary>
        public string FuncAllocationPROB { get; set; }
        ...
        public bool Init(ref XmlNode configSet, ref XmlNode telegramSet)
        {
            ...
            try
            {
                ...
                {
                    if (_logger.IsErrorEnabled)
                        _logger.Error("Get pessenger info storeprocedure setting cannot be empty! <" + thisMethod + ">");
                ...
                FuncAllocationDUMP = (XMLConfig.GetSettingFromInnerText(
                           configSet, DB_FUNC_ALLOCATION_DUMP, string.Empty)).Trim();
                if (FuncAllocationDUMP == string.Empty)
                {
                    if (_logger.IsErrorEnabled)
                        _logger.Error("<" + DB_FUNC_ALLOCATION_DUMP + "> setting can not be empty! <" + thisMethod + ">");
                ...
                FuncAllocationPROB = (XMLConfig.GetSettingFromInnerText(
                           configSet, DB_FUNC_ALLOCATION_PROB, string.Empty)).Trim();
                if (FuncAllocationPROB == string.Empty)
                {
                    if (_logger.IsErrorEnabled)
                        _logger.Error("<" + DB_FUNC_ALLOCATION_PROB + "> setting can not be empty! <" + thisMethod + ">");
