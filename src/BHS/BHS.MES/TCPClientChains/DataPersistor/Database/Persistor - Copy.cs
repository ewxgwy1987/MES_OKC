...
namespace BHS.MES.TCPClientChains.DataPersistor.Database
{
    ...
    public class Persistor : IDisposable
    {
        ...
        /// <param name="PLCIndex">TTS Index No. as  type of System.string</param>
        public void InsertItemReady(DateTime TimeStamp, string GID, string LicensePlate, 
            string SubSystem, string Location, string PLCIndex)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            ...
            try
            {
                ...
                SqlParameter sqlPara1 = sqlCmd.Parameters.Add("@TIME_STAMP", SqlDbType.DateTime);
                sqlPara1.Value = TimeStamp;

                SqlParameter sqlPara2 = sqlCmd.Parameters.Add("@GID", SqlDbType.VarChar, 10);
                sqlPara2.Value = GID;

                SqlParameter sqlPara3 = sqlCmd.Parameters.Add("@LICENSE_PLATE", SqlDbType.VarChar, 10);
                sqlPara3.Value = LicensePlate;

                SqlParameter sqlPara4 = sqlCmd.Parameters.Add("@SUBSYSTEM", SqlDbType.VarChar, 10);
                sqlPara4.Value = SubSystem;

                SqlParameter sqlPara5 = sqlCmd.Parameters.Add("@LOCATION", SqlDbType.VarChar, 20);
                sqlPara5.Value = Location;

                SqlParameter sqlPara6 = sqlCmd.Parameters.Add("@INDEX_NO", SqlDbType.VarChar, 10);
                sqlPara6.Value = PLCIndex;
        ...
        /// <summary>
        /// Insert Item Insert Ack into DB
        /// </summary>
        /// <param name="TimeStamp">Time stamp which insert data as type of System.DateTime</param>
        /// <param name="SubSystem">Sub system information as type of System.string</param>
        /// <param name="Location">Location as type of System.string</param>
        public void InsertItemInsertAck(DateTime TimeStamp, string SubSystem, string Location)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            SqlConnection sqlConn = null;
            SqlCommand sqlCmd = null;
            ...
            try
            {
                ...
                sqlCmd = new SqlCommand(ClassParameters.stp_MES_INSERT_ITEM_INSERTACK, sqlConn);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                ...
                SqlParameter sqlPara3 = sqlCmd.Parameters.Add("@LOCATION", SqlDbType.VarChar, 20);
            ...
            catch (SqlException ex)
            {
                ...
                if (_logger.IsErrorEnabled)
                    _logger.Error("Inserting Item Insert Acknowledge information failure! <" + thisMethod + ">", ex);
            }
            catch (Exception ex)
            {
                if (sqlTrans != null)
        ...
        /// <summary>
        /// Insert Item Insert into DB
        /// </summary>
        /// <param name="TimeStamp">Time stamp which insert data as type of System.DateTime</param>
        /// <param name="SubSystem">Sub system information as type of System.string</param>
        /// <param name="Location">Location as type of System.string</param>
        public void InsertItemInsert(DateTime TimeStamp, string SubSystem, string Location)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            SqlConnection sqlConn = null;
            SqlCommand sqlCmd = null;
            ...
            try
            {
                ...
                sqlCmd = new SqlCommand(ClassParameters.stp_MES_INSERT_ITEM_INSERT, sqlConn);
                sqlCmd.CommandType = CommandType.StoredProcedure;
            ...
            catch (SqlException ex)
            {
                ...
                if (_logger.IsErrorEnabled)
                    _logger.Error("Inserting Item Insert information failure! <" + thisMethod + ">", ex);
            }
            catch (Exception ex)
            {
                if (sqlTrans != null)
        ...
        /// <param name="EncodeType">Encoding type as type of System.string</param>
        /// <param name="MESStation">MES station name as type of System.string</param>
        /// <param name="SortReason">Sort reason for bag as Type of System.String</param>
        /// <param name="PLCIndex">PLC index no. as Type of System.String</param>
        public void InsertItemEncoded(DateTime TimeStamp, string GID, string LicensePlate, 
            string SubSystem, string Location, string Destination, string EncodeType, 
            string MESStation, string SortReason, string PLCIndex)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            SqlConnection sqlConn = null;
            SqlCommand sqlCmd = null;
            ...
            try
            {
                ...
                SqlParameter sqlPara6 = sqlCmd.Parameters.Add("@DESTINATION", SqlDbType.VarChar, 20);
                ...
                SqlParameter sqlPara8 = sqlCmd.Parameters.Add("@MES_STATION", SqlDbType.VarChar, 16);
                sqlPara8.Value = MESStation;

                SqlParameter sqlPara9 = sqlCmd.Parameters.Add("@SORT_REASON", SqlDbType.VarChar, 2);
                sqlPara9.Value = SortReason;

                SqlParameter sqlPara10 = sqlCmd.Parameters.Add("@INDEX_NO", SqlDbType.VarChar, 10);
                sqlPara10.Value = PLCIndex;
        ...
        /// <param name="Location">Location as type of System.string</param>
        /// <param name="MESStation">MES station name as  type of System.string</param>
        public void InsertItemRemove(DateTime TimeStamp, string GID, string LicensePlate, 
            string SubSystem, string Location, string Index)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            SqlConnection sqlConn = null;
            SqlCommand sqlCmd = null;
        ...
        /// <param name="sTTSID"></param>
        /// <returns>Return the list of pessenger info as type of System.Data.DataTable</returns>
        public DataTable GetPassengerInfo(string LicensePlate, string bagGID, string sTTSID)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            SqlConnection sqlConn = null;
            SqlCommand sqlCmd = null;
            ...
            try
            {
                ...
                SqlParameter sqlPara1 = sqlCmd.Parameters.Add("@LicensePlate", SqlDbType.VarChar,10);
                sqlPara1.Value = LicensePlate;

                SqlParameter sqlPara2 = sqlCmd.Parameters.Add("@GID", SqlDbType.VarChar, 10);
                sqlPara2.Value = bagGID;

                SqlParameter sqlPara3 = sqlCmd.Parameters.Add("@TTS", SqlDbType.VarChar, 10);
                sqlPara3.Value = sTTSID;
            ...
            {
                if (_logger.IsErrorEnabled)
                    _logger.Error("Get pessenger information failure! <" + thisMethod + ">", ex);
            }
            catch (Exception ex)
            {
                if (_logger.IsErrorEnabled)
        ...
        public string GetInfoReason(string sGUID, string sLicensePlate)
        {
            ...
            if (dsPessengerInfo.Tables[0].Rows.Count > 0)
            {
            ...
            DateTime sdo, string description, string mesStation, string subSystem, string location)
        {
            ...
            try
            {
                ...
                InsertMESEvent(DateTime.Now, sNewInhouseTag, sNewInhouseTag, subSystem, location, ClassParameters.MES_Station_Name, "UPDINHOUSE", "UPD INHOUSE TAG");
                sqlTrans.Commit();
            }
            catch (SqlException ex)
            {
        ...
        public void MinimumHBSSecurityLevelMeetChecking(string gid, out bool isMeet, string minimumSecurityLevel, out string currentSecurityLevel,
                out bool isEBS, bool isIATAInterlineInHouseTag, string licensePlate, bool isInduction)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            SqlConnection sqlConn = null;
            SqlCommand sqlCmd = null;
            ...
            try
            {
                ...
                sqlCmd.Parameters.Add("@CurrentHBSLevel", SqlDbType.VarChar, 1);
        ...
        /// <param name="gid"></param>
        /// <param name="isMeet"></param>
        public void CustomsSecurityMeetChecking(string gid, out bool isMeet, bool isIATAInterlineInHouseTag, string licensePlate)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            SqlConnection sqlConn = null;
            SqlCommand sqlCmd = null;
        ...
        /// <returns></returns>
        public LocationID[] GetDestinationOfCustomsChute(string channelName, string gid, ref string reason, LocationID currentLocation,
                string tts)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
                   ...
                   string tts)
        {
            ...
            try
            {
                ...
                if ((validTag.Type == TagType.IATATag) || (validTag.Type == TagType.InHouseTag))
                {
                    ...
                    if (status == 1)
                    {
                        ...
                        if (_logger.IsInfoEnabled)
                            _logger.Info("[DEBUG] [GID:" + gid + ", LP:" + validTag.LP +
                    ...
                    case 8:
                        ...
                        if (tempLocationID != null)
                        {
                            if (tempLocationID.Length > 1)
                            {
                                ...
                                {
                                    if (_logger.IsInfoEnabled)
                                        _logger.Info("[DEBUG] [GID:" + gid + ", LP:" + validTag.LP + ", Class:" + bsmTravelClass +
                    ...
                    switch (reader.FieldCount)
                    {
                        ...
                        case 24:
                            ...
                            alloc = new AllocationProperty(AllocationType.FlightAllocation, ClassParameters.RelatedNameSTD,
                                    ClassParameters.RelatedNameETD, ClassParameters.RelatedNameITD, ClassParameters.RelatedNameATD);
                ...
                out bool isMES, string tts, AllocationProperty[] originalAllocations)
        {
            ...
            try
            {
                ...
                else if (early.Length != 0 & early != null)  // Don't have allocation is in RUSH state, then check EARLY state
                {
                    if (EarlyEnabled)
                    {
                        if (_logger.IsInfoEnabled)
                ...
                ref string reason, ref LocationID[] destinations, string tts)
        {
            ...
            try
            {
                ...
                GetSortedDestOfFunctionAllocation(ref reason, gid, channelName, ClassParameters.FuncAllocationPROB,
                            currentLocation, ref destinations, mesLocation, tts);

                if (_logger.IsInfoEnabled)
                    _logger.Info("[Channel:" + channelName +
                            "] [GID:" + gid +
                            "] is " + ClassParameters.FuncAllocationPROB +
                            " item. Its destination: [" +
                            Utilities.LocationIDArrayToString(ref destinations) +
                            "] . <" + thisMethod + ">");
        ...
        /// <param name="destinations"></param>
        /// <returns></returns>
        private bool ChuteAvailableCheck(LocationID destinations)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            SqlConnection sqlConn = null;
            SqlCommand sqlCmd = null;
            ...
            try
            {
                ...
                if (destination != null)
                {
                    foreach (LocationID temp in destination)
                    {
                        if (ClassParameters.EDSCDSChute.Contains(temp.Location) == false)
                        {
                            ...
                            // 1. Query destination and its Subsystem of given Function Allocation 
                            //    type from table [FUNCTION_ALLOC_GANTT], [FUNCTION_ALLOC_LIST];
                            destination = GetDestinationOfFunctionAllocation(ClassParameters.FuncAllocationDUMP, string.Empty, ref isMES, tts);
                            break;
                        }
                    }
                }
                ...
                if (destination == null)
                {
                    ...
                    if (_logger.IsWarnEnabled)
                        _logger.Warn("[Channel:" + channelName +
                                "] There is no destination was defined for " +
                                "Function Allocation (" + ClassParameters.FuncAllocationDUMP +
                                ")! The pre-set destination will be assigned to it. <" + thisMethod + ">");
                ...
                if (_logger.IsInfoEnabled)
                    _logger.Info("[Channel:" + channelName +
                            "] [GID:" + gid +
                            "] which is " + ClassParameters.FuncAllocationDUMP +
        ...
        private void GetCancellationOfFlight(string licensePlate, out string flightCancellation)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            SqlConnection sqlConn = null;
            SqlCommand sqlCmd = null;
            ...
            try
            {
                ...
                {
                    flightCancellation = sqlCmd.Parameters["@FlightCancellation"].Value.ToString();
                }
            }
            catch (SqlException ex)
            {
        ...
        public bool CheckUserInDomain(string sLoginUser)
        {
            ...
            try
            {
                ...
                if (domainStatus)
                {
                    ...
                    bReturnValue = securityManager.GetStatusByUser(Environment.UserName, out errorMsg);
        ...
        /// <param name="licensePlate"></param>
        /// <returns></returns>
        public int GetBagNoBSMReOccuranceCount(string sGID, string sStatus, int iTotalLimit, string sAlarmType, string sEquipmentID)
        {
            string thisMethod = _className + "." + System.Reflection.MethodBase.GetCurrentMethod().Name + "()";
            SqlConnection sqlConn = null;
            SqlCommand sqlCmd = null;
            ...
            try
            {
                ...
                if (ClassParameters.MainDBAlive == true)
                {
                    ...
                    SqlParameter sqlPara2 = sqlCmd.Parameters.Add("@STATUS", SqlDbType.VarChar, 2);
                    sqlPara2.Value = sStatus;

                    SqlParameter sqlPara3 = sqlCmd.Parameters.Add("@TOTAL_LIMIT", SqlDbType.Int);
                    sqlPara3.Value = iTotalLimit;

                    SqlParameter sqlPara4 = sqlCmd.Parameters.Add("@ALARM_TYPE", SqlDbType.VarChar, 20);
                    sqlPara4.Value = sAlarmType;

                    SqlParameter sqlPara5 = sqlCmd.Parameters.Add("@EQUIPMENT_ID", SqlDbType.VarChar, 10);
                    sqlPara5.Value = sEquipmentID;
        ...
        public void GetAllMESSetting()
        {
            ...
            {
                if (_logger.IsErrorEnabled)
                    _logger.Error("Get filter information fail! <" + thisMethod + ">", ex);
            }
            catch (Exception ex)
            {
                if (_logger.IsErrorEnabled)
